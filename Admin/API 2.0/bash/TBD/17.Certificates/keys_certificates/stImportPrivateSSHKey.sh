...
#
#{"account": "t1","type": "ssh", "usage": "private", "password":"axway123","accessLevel": "PRIVATE", "name":"pippinscert"}
#
#--floki1234
...
# 
cat stImportPrivateSSHKey.multipart1 stImportPrivateSSHKey.pem stImportPrivateSSHKey.multipart2 > fish.txt
