...
# Example of 
# 
# V1.00 Ian Percival   20-Oct--2020
#
# This script will add the composite route to the subscription - both identified by IDs
#
# APIs used - /myself ( ST login and logout )
#             /routes ( GET and PUT )
#
# Usage: ./stAddCompositeRouteToSubscription.py compRouteId subscriptionId
#
# Outputs:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print 'Please provide an input argument 2 for the subscriptionID'
        quit()
